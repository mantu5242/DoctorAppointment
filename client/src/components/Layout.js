  ...
  return (
    ...
    <div className="main" style={{height:'100%',padding:'15px',display:'flex',flexDirection:'column'}}>
        <div className="layout" style={{display:'flex',height:'100%'}}>
            <div className="sidebar" style={{width:'350px',maxheight:'100%',borderRadius:'10px',background:'rgb(7, 48, 7)',marginRight:'20px',boxShadow:' rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 2px 6px 2px'}}>
            ...
            <div className="content" style={{display:'flex',flexDirection:'column',width:'100%',height:'100%'}}>
                <div className="header" style={{height:'10vh',marginBottom:'20px',background:'rgb(7, 48, 7)',boxShadow:'box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px',width:'100%',borderRadius:'10px'}}>
                ...
                <div className="body" style={{background:'rgb(197, 254, 191)',boxShadow:'box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px',width:'100%',borderRadius:'10px'}}>{children}</div>
            </div>
        </div>
    </div>
