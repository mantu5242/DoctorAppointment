...
const { getDoctorInfoController, updateProfileController, doctorAppointmentsController, updateStatusController, getDoctorBYIdController } = require('../controllers/doctorCtrl');
